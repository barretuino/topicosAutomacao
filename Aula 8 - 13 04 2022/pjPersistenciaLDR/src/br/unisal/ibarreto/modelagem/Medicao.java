package br.unisal.ibarreto.modelagem;
/**
 * Projeto de Gerência
...
import br.unisal.ibarreto.jdbc.MedicaoDAO;
...
public class Medicao implements SerialPortEventListener {
	...
	**/
				...
				for(int i=0; i<available; i++){
					if(chunk[i]=='$')
						...
						if(chunk[i]=='#'){
							...
							System.out.println("Gravação realizada na MIB: " + leitura.getValor());							
						}else
	...
	public static void main(String[] args) throws Exception {
		Medicao main = new Medicao("COM4", 2000, 9600);
		main.initialize();
